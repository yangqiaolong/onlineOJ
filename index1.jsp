...
<body ng-controller="indexCtr">
	...
	<div>
		<ul class="nav navbar-nav">
			...
			<li onclick="selectLi(this)"><a href="goToUserInfo">个人信息</a></li>
			<li></li>
			<li></li>
			<li></li>
		</ul>
		<div>
			<label ng-if="${id}  != null" id="userTip"><font color="#708090">欢迎：{${id}}</font> </label>
				<button onclick="logOut()" class="btn btn-primary1"> 退出登陆</button>
		</div>
	</div>
	...
	<div class="container">
		...
		<div>
			<ul class="nav navbar-nav">
				...
				<li></li>
				<li></li>
				<li onclick="selectLi(this)"><a>首页</a></li>
				<li></li>
				<li></li>
				<li onclick="selectLi(this)"><a href="publishIndex">公告</a></li>
				<li></li>
				<li></li>
				<li onclick="selectLi(this)"><a href="problemIndex">题目</a></li>
				<li></li>
			...
			<div>
				<label ng-if="${id}  != null" id="userTip">欢迎：{${id}} </label>
				<button class="btn btn-primary"> <a href="logOut"><font
					color="white">退出登陆</font></a> </button>
			</div>
		</div>
	</div>
				...
				<div class="modal-body">
					<form action="log" class="form-horizontal"
						...
						<div class="form-group">
							<i class="icon-user"></i><input id="id" name="id" type="text"
								class="form-control" placeholder="账号：长度为6-20位的，数字"
								ng-model="loginData.account" pattern="[a-zA-Z0-9]{6,20}"
								required>{{error.accountError}} 
						</div>
						<div class="form-group">
							<i class="icon-key"></i><input id="password" name="password"
	...
	<div class="modal fade dialog" id="forgetDialog">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="findPassword" class="form-horizontal"
						ng-submit="forgetUpdate()">
						<span class="heading">忘记密码-修改密码</span>
						<div class="form-group">
							<i class="icon-user"></i><input id="id" name="id" type="text"
								class="form-control" placeholder="账号：长度为6-20位的，数字或者英文字母"
								ng-model="forgetData.account" pattern="[a-zA-Z0-9]{6,20}"
								required>{{error.accountError}} 
						</div>

						<div class="form-group">
							<i class="icon-font"></i><input id="name" name="name" type="text"
								class="form-control" placeholder="你的姓名"
								ng-model="registerData.nickname" "
								required>{{error.accountError}}
						...
						<div class="form-group">
							<i class="icon-key"></i><input id="password" name="password"
								type="password" class="form-control"
								placeholder="新密码：长度为6-20位的，数字或者英文字母"
								ng-model="forgetData.newPassword" pattern="[a-zA-Z0-9]{6,20}"
								required>{{error.passwordError}} 
						</div>
						<div class="form-group">
							<i class="icon-key"></i><input id="password2" name="password2"
								type="password" class="form-control"
								placeholder="确认新密码：长度为6-20位的，数字或者英文字母"
	...
	<div class="modal fade dialog" id="registerDialog">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="regist" class="form-horizontal"
						...
						<div class="form-group">
							<i class="icon-key"></i><input id="password2" name="password2"
								type="password" class="form-control"
								placeholder="确认密码：长度为6-20位的，数字或者英文字母"
...
<%String s = (String) request.getAttribute("id");
			...
			System.out.print("这是我的session：" + s);%>
