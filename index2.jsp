...
<meta charset="UTF-8">
	<title>在线评测系统</title>
	<link rel="SHORTCUT ICON" href="static/img/timg.jpg">
		<link rel="BOOKMARK" href="static/img/timg.jpg">
...
<body ng-controller="indexCtr">
	...
	<div>
		<ul class="nav navbar-nav">
			...
			<li></li>
			<li></li>
			<li onclick="selectLi(this)"><a onclick="sorry()">首页</a></li>
			<li></li>
			<li></li>

			<li onclick="selectLi(this)"><a onclick="sorry()">公告</a></li>
			<li></li>
			<li></li>

			<li onclick="selectLi(this)"><a onclick="sorry()">题目</a></li>
			<li></li>
			<li></li>

			<li onclick="selectLi(this)"><a onclick="sorry()">个人信息</a></li>
			<li></li>
		</ul>
		<script>
				function sorry(){
