...
<title>源代码在线评测管理员登陆界面</title>
<link rel="SHORTCUT ICON" href="staticimg/logo.png">
...
<script type="text/javascript">
	function submit() {
		$.ajax({
			type : "post",
			url : "../AdminManagerController/login",
			data : {
				account : $("#account").val(),
			...
			success : function(respones) {
				if (respones.success) {
					window.location = "managerindex.jsp";
				}
			},
			error : function(respones) {
				$("#message").html(respones.responseJSON.message);
			},
		});
	}
</script>
