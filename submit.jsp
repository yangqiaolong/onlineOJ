	...
	<div>
		...
		<table class="table table-striped">
			<table class="table table-striped">
				<thead>
					<tr>
						<th class="col-md-1">Time Limit(ms)</th>
						<th class="col-md-1">Memory Limit(KB)</th>
						<th class="col-md-1">Accuracy Rate</th>
					</tr>
				</thead>
				<tbody>
					<tr>
			...
			<div id="problemContent">
				...
				<pre class="sample">${ testdata.data_in}</pre>
				<div class="problemIteam">Sample Output:</div>
				<pre class="sample">${ testdata.data_out}</pre>
				...
				<form accept-charset="UTF-8" id="problem_submit"
					...
					<div class="field">
						...
						<textarea id="code" name="code" autofocus="" rows="10" cols="140"
							style="overflow: scroll; overflow-x: hidden">${ code}</textarea>
					</div>
					<div class="actions">
